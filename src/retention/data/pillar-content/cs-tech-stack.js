  ...
  sections: [
    {
      ...
      body: [
        ...
        "Third, automation capability. Every tool should reduce manual work, not add it. If a new platform requires CSMs to manually log activities, update fields, or generate reports that were previously automated, you're moving backward. The test is simple: does this tool free up CSM time for customer-facing work, or does it consume more of it?"
      ],
      callout: {
        type: "warning",
        text: "The number one stack mistake is buying a platform to solve a process problem. If your team doesn't have a defined renewal process, a renewal management tool won't create one. It will automate chaos. Fix the process first, then automate it."
      },
    },
    {
    ...
    },
    {
      ...
      body: [
        ...
        "The third mistake is under-investing in the data layer. Teams spend heavily on intelligence and action platforms but leave their CRM neglected, their product analytics unconnected, and their support data siloed. The result is sophisticated tools running on bad data — beautifully designed dashboards showing wrong numbers. Invest disproportionately in data quality and integration. It's less exciting than a new platform, but it's what makes everything else work."
      ],
      callout: {
        type: "example",
    ...
    },
    {
      ...
      body: [
        "Before you evaluate any tool, document what you need in a structured framework. Start with your current-state assessment: what do you have today, what's working, what isn't, and where are the gaps? Map your existing tools to the four-layer model. Identify which layers are strong and which are weak.",
        "Next, define your requirements by layer. Be specific. Don't write that you need \"better health scoring.\" Write that you need a health scoring engine that ingests product usage data via API, supports multi-dimensional scoring, validates against renewal outcomes quarterly, and triggers playbooks in your existing workflow tool. The more specific your requirements, the faster your evaluation moves and the better your decision will be.",
        "Score every candidate tool against the same criteria with the same rubric. Involve CS Ops, a senior CSM, and your data or systems team in the evaluation. CS Ops understands the operational requirements. The CSM provides the end-user perspective. The data team evaluates integration feasibility and data model fit. If any of these three stakeholders has a serious objection, don't proceed — a tool that fails on any one of these dimensions will underperform."
      ],
      bullets: [
        ...
        "Run a proof of concept on your actual data before committing — vendor demos use clean data that doesn't reflect your reality",
