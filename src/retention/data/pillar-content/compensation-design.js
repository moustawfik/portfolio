  ...
  sections: [
    {
      ...
      body: [
        ...
        "When you add expansion revenue to the mix, you create a second problem. CSMs start behaving like account executives — pushing for upsells before the customer has fully adopted what they already own. The customer experience degrades because the person who is supposed to be their advocate is now trying to sell to them. Some customers tolerate it. The sophisticated ones recognize the shift and start limiting access to decision-makers."
      ],
      callout: {
        type: "insight",
        text: "Ask your CSMs privately what they optimize for when they allocate their time each week. If the answer does not match your stated CS strategy, your comp plan is the likely culprit."
      },
    },
    {
      ...
      body: [
        ...
        "Activity-weighted plans are safer and easier to administer. They reward the behaviors you believe lead to retention, and they give CSMs clear control over their variable comp. The downside is that activity does not equal outcome. A CSM can complete every QBR, log every activity, and run every playbook, and the customer can still churn because the underlying product fit was wrong or the market shifted. You end up paying full variable comp for a team that is busy but not effective.",
        "Retention-weighted plans are harder to administer but align incentives more directly with business outcomes. The risk is that CSMs feel penalized for outcomes beyond their control — a customer acquired through a bad-fit sales process, a product failure that drives churn, a budget cut at the customer that has nothing to do with value delivery. The solution is not to choose one approach exclusively. It is to blend them with the right ratio."
      ],
      table: {
    ...
    },
    {
      ...
      body: [
        ...
        "For CS Ops, variable compensation should be tied to system-level metrics — data quality improvements, process adoption rates, health score predictive accuracy, and operational efficiency gains. Do not tie CS Ops comp to retention rate directly. They influence retention through the systems they build, but they do not control individual account outcomes. Measuring them on retention creates accountability without agency, which is demoralizing and unfair. CS leadership should be compensated on portfolio-level retention and expansion, plus strategic milestones like org design improvements, tech stack maturity, and operational scalability metrics."
      ],
      callout: {
        type: "example",
    ...
    },
    {
      ...
      body: [
        "Comp design is not just an HR exercise. It is a customer experience decision. What you incentivize determines how your team spends their time, and how your team spends their time determines what the customer experiences. If you incentivize QBR completion, your customers get consistent quarterly engagement. If you incentivize expansion revenue, your customers get pitched. If you incentivize adoption milestones, your customers get proactive enablement.",
        "The chain is direct: comp structure shapes CSM behavior, CSM behavior shapes customer experience, customer experience shapes retention. When you design a comp plan, you are designing a customer experience whether you intend to or not. This is why comp design should involve CS leadership, CS Ops, and finance working together. Finance ensures the plan is economically sound. CS leadership ensures it drives the right strategy. CS Ops ensures the metrics are measurable and the data is reliable.",
      ...
      callout: {
        type: "warning",
        text: "If your comp plan incentivizes retention rate but your primary churn driver is bad-fit customers acquired by sales, you are punishing CSMs for a sales problem. Comp plans must account for the full system, not just the CS function in isolation."
      },
    },
    {
      ...
      bullets: [
        ...
        "Complexity overload: Plans with more than four or five components that CSMs cannot mentally model when making daily prioritization decisions",
      ],
    },
  ],
};
