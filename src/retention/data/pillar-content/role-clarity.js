export default {
  lede: "The most expensive inefficiency in post-sale organizations isn't bad tooling or missing data. It's ambiguity about who owns what. When support, CS, and account management overlap without clear boundaries, customers get inconsistent experiences and revenue falls through the cracks.",
  sections: [
    {
      ...
      body: [
        ...
        "The failure mode is treating them as the same job. When a CSM spends 60% of their time on what is effectively Tier 2 support — fielding how-to questions, troubleshooting bugs, chasing down product issues — they're not doing revenue work. They're doing support work with a more expensive title. You're paying senior salaries for junior work, and the actual revenue work isn't getting done."
      ],
      callout: {
        type: "insight",
    ...
    },
    {
      ...
      body: [
        "A clean role architecture assigns every customer interaction type to a specific owner. No ambiguity. When two roles both think they own something, neither does it well. When neither thinks they own it, it doesn't get done at all.",
        ...
        "The key principle is single-threaded ownership at every stage. The customer should never have to figure out who to contact. Internally, every metric should map to exactly one role. If two roles are measured on the same number without clear delineation of contribution, you'll get finger-pointing when it goes poorly and credit-grabbing when it goes well. I've seen both. Neither is pretty."
      ],
      table: {
    ...
    },
    {
      ...
      body: [
        "Role ambiguity doesn't just create internal confusion. It creates customer-facing damage that directly impacts retention.",
    ...
    },
    {
      ...
      body: [
        "Role clarity on paper means nothing if incentives pull people in a different direction. Your compensation and performance structures must reinforce the boundaries you've defined. If you tell CSMs their job is adoption and retention but bonus them on expansion revenue, they'll chase expansion at the expense of adoption. People respond to incentives, not org charts.",
        ...
        "Review your incentive structure against your role architecture quarterly. As the business evolves, these two things drift apart. A comp plan designed for a 200-customer book doesn't work for a 500-customer book. An incentive designed when CSMs owned renewals doesn't work after you stand up a renewal desk."
      ],
      callout: {
        type: "warning",
    ...
    },
    {
      ...
      body: [
        "Every handoff in the customer lifecycle is a moment of risk. Information gets lost, context disappears, and the customer has to re-explain their situation to a new person. You can't eliminate handoffs, but you can design them so well that the customer barely notices.",
