export default {
  lede: "The quarterly business review is the highest-leverage touchpoint in the customer relationship. It is also the most frequently wasted. Most QBRs are status updates disguised as strategic conversations. When you redesign the QBR as a retention and expansion instrument, it becomes the single best predictor of renewal outcomes.",
  sections: [
    {
      ...
      body: [
        ...
        "This is not a business review. It is a report-out that could have been an email. The anti-pattern is treating the QBR as a CSM presentation instead of a strategic dialogue. The CSM talks for 40 minutes and listens for 5. The data shown is backward-looking and operational — things the customer already knows or does not care about. There is no connection between the data presented and the customer's stated business objectives.",
        "The second anti-pattern is inconsistency. QBRs happen when the CSM remembers to schedule them, skip a quarter when things get busy, and are cancelled when the customer is too busy. If your QBR cadence is optional, it sends a clear message: this meeting is not important. And if it is not important, it will not influence the renewal decision."
      ],
      bullets: [
    ...
    },
    {
      ...
      body: [
        ...
        "Operational check-ins happen monthly or biweekly. They are short, tactical, and focused on adoption, open issues, and immediate next steps. These are owned by the CSM and the customer's day-to-day users. The QBR happens quarterly with middle management. It connects product usage to business outcomes and surfaces risks or opportunities. The strategic review happens once or twice a year with the economic buyer or executive sponsor. It is a value conversation — here is what you invested, here is what you got, here is what the next phase looks like.",
        "The critical mistake is running executive-level content in a manager-level meeting, or vice versa. Executives do not care about feature adoption percentages. They care about whether the investment is producing returns. Managers do not care about three-year strategic roadmaps. They care about whether their team can get their work done. Match the content to the audience."
      ],
      table: {
    ...
    },
    {
      ...
      body: [
        ...
        "The most powerful data point in any QBR is one that surprises the customer. If you can surface an insight about their business that they did not already know — a usage pattern that reveals an efficiency gap, a benchmark comparison that shows they are underperforming peers, a trend that predicts a problem six months out — you have demonstrated that the partnership produces value beyond the product itself."
      ],
      callout: {
        type: "insight",
    ...
    },
    {
      ...
      body: [
        ...
        "Accounts that complete all four quarterly QBRs renew at meaningfully higher rates than accounts that skip one or more. This is partly selection bias — engaged customers are more likely to show up. But it is also causal. The QBR is where misalignment gets surfaced and corrected. Without it, small issues compound into renewal risk. An account that skips two consecutive QBRs should be flagged as at-risk regardless of what your health score says.",
        "Stakeholder seniority matters because the renewal decision is made by the economic buyer, not by the end users. If your QBRs only involve practitioners and project managers, you are maintaining the operational relationship but not the commercial one. The person who signs the renewal has no direct experience of the value you provide. When budget pressure hits, you are an easy line item to cut because no one in the room remembers why the investment was made."
      ],
      callout: {
        type: "example",
