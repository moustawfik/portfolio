export default {
  lede: "Most CS organizations are structured to respond to problems. That is a service model, not a retention model. Revenue retention becomes predictable only when you treat it as infrastructure — systems, layers, and feedback loops that operate whether or not any individual contributor is having a good week.",
  sections: [
    {
      heading: "Why Most CS Orgs Are Structured Wrong",
      body: [
        "The default CS org chart looks like this: a VP of CS sits above a group of CSMs who each own a book of business. The CSMs do everything — onboarding, support escalation, adoption tracking, renewal conversations, expansion discovery. They are generalists operating in a system that rewards heroics over repeatability.",
        ...
        "When you structure CS as a service org, you get inconsistent outcomes. Your best CSMs carry the number, and when they leave, their accounts churn. You cannot scale a revenue function on individual talent alone. You need architecture."
      ],
      callout: {
        type: "insight",
        text: "If your retention rate changes materially when a single CSM leaves, you do not have a retention system. You have a collection of individual relationships with no structural backbone."
      },
    },
    {
      heading: "From Customer Happiness to Revenue Retention Infrastructure",
      body: [
        "The shift is straightforward but uncomfortable: stop measuring CS by satisfaction scores and start measuring it by the revenue it protects and expands. This does not mean you ignore customer experience. It means you recognize that experience is an input to retention, not the metric itself.",
        "Revenue retention infrastructure means you have documented, repeatable processes for every stage of the post-sale lifecycle. Onboarding has defined milestones and exit criteria. Adoption is tracked against benchmarks, not gut feel. Risk is identified through signals, not CSM intuition alone. Renewal execution starts 120 days out with a defined playbook, not 30 days out with a panicked email.",
        "The organizations that run 95%+ gross retention do not have better CSMs. They have better systems. Their CSMs operate inside a framework that catches risk early, surfaces expansion opportunities systematically, and ensures that no account falls through the cracks because someone was on vacation."
      ],
    },
    {
      ...
      body: [
        ...
        "The Operational Layer is the foundation. This is where data flows, health scores update, alerts trigger, and playbooks execute. It is owned by CS Operations. If this layer is weak, everything above it is guesswork. The operational layer answers: what is happening across the book of business right now?",
        "The Commercial Layer sits above operations. This is where CSMs and renewal managers execute — running QBRs, negotiating renewals, identifying expansion. The commercial layer depends on operational data to prioritize and act. Without it, CSMs default to squeaky-wheel management. This layer answers: what should we do about what is happening?",
        "The Strategic Layer is the leadership function. This is where you set segmentation strategy, define resource allocation models, design compensation structures, and make build-vs-buy decisions on tooling. The strategic layer answers: are we building the right machine?"
      ],
      table: {
    ...
    },
    {
      ...
      body: [
        "Predictability comes from reducing variance. In a heroics-driven CS org, outcomes are normally distributed around the talent of your team. In a systems-driven org, outcomes are tightly clustered because the floor is high — even a mediocre CSM inside a strong system produces acceptable retention numbers.",
        ...
        "The goal is not to eliminate churn. Some churn is healthy — customers who are a bad fit should leave. The goal is to eliminate surprise churn. If you are surprised by a non-renewal, your system has a gap."
      ],
      callout: {
        type: "warning",
        text: "Predictable retention does not mean zero churn. It means every churned account can be traced to a known risk factor that was either identified and unresolvable, or identified too late due to a specific system gap you can now fix."
      },
    },
    {
      heading: "Measuring Retention Architecture Maturity",
      body: [
        "You can assess where your org sits on a five-level maturity scale. Most companies are at Level 1 or 2 and believe they are at Level 3. Be honest with yourself — the assessment only works if you are.",
