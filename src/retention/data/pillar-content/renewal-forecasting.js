  ...
  sections: [
    {
      ...
      body: [
        "Your CRM knows the contract end date. It might know the ARR value and the assigned CSM. But it does not know that the champion who signed the deal left three months ago. It does not know that product usage dropped 40% after the last release broke their core workflow. It does not know that three support tickets this quarter were tagged as escalations, or that the VP of Operations stopped attending QBRs.",
        ...
        "Industry data suggests that typical CRM-based forecast accuracy sits around 60-65% for most B2B SaaS organizations. That means one in three renewal predictions is wrong. At scale, that is not a forecasting model — it is a coin flip with extra steps."
      ],
      callout: {
        type: 'insight',
    ...
    },
    {
      ...
      bullets: [
        ...
        "Support Sentiment — Total ticket volume is a vanity metric. What matters is the trend (increasing or decreasing), the severity distribution (more escalations?), and the resolution satisfaction. A customer submitting zero tickets is not necessarily healthy — they might have stopped trying.",
    ...
    },
    {
      ...
      body: [
        "The waterfall model above shows how a renewal cohort flows from total pipeline to final outcome. At each stage, signals push accounts into confidence tiers. The goal is not perfect prediction — it is directional accuracy that improves over time.",
    ...
    },
    {
      ...
      body: [
        "A forecast model is only useful if you track its accuracy and refine it. After each renewal cycle, compare predictions to outcomes at every confidence tier.",
      ...
      callout: {
        type: 'warning',
        text: "Do not optimize for forecast accuracy at the expense of intervention speed. A model that perfectly predicts churn but gives you no time to act is just an expensive obituary."
      },
    },
  ],
};
